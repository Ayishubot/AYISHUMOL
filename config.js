...
module.exports = {
    ...
    PLKIMG: process.env.LIST_IMG === undefined ? 'https://i.imgur.com/d4DIca6.jpeg' : process.env.LIST_IMG,
    WEL_GIF: process.env.WEL_GIF === undefined ? 'https://i.imgur.com/d4DIca6.jpeg' : process.env.WEL_GIF,
    GIF_BYE: process.env.GIF_BYE === undefined ? 'https://i.imgur.com/d4DIca6.jpeg' : process.env.GIF_BYE,
